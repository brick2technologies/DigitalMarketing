...
export default function OfferLeadFormSection() {
    ...
    return (
        <section id="contact" className="relative bg-blue-50/40 pt-12 pb-5">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="rounded-3xl bg-white border border-blue-200 shadow-lg p-6 md:p-8"
                >
                    {!submitted ? (
                        <form
                        ...
                        >
                            ...
                            <div>
                                ...
                                <select className="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div className="md:col-span-2 mt-3">
                                <button
                                    type="submit"
                                    className="w-full rounded-full bg-blue-600 px-6 py-3 text-sm font-medium text-white hover:bg-blue-700 transition"
                                >
                                    Request a Custom Strategy Plan
                                </button>

                                <p className="mt-3 text-xs text-gray-600 text-center">
                                    Clear, actionable next steps — no spam.
                                </p>
                            </div>
                        </form>
                    ) : (
